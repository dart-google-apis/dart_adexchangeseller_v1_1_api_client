part of adexchangeseller_v1_1_api;
...
class PreferreddealsResource_ {

  final Client _client;

  PreferreddealsResource_(Client client) :
      _client = client;
   ...
   * [optParams] - Additional query parameters
   */
  async.Future<PreferredDeal> get(core.String dealId, {core.Map optParams}) {
    var url = "preferreddeals/{dealId}";
    var urlParams = new core.Map();
    var queryParams = new core.Map();
   ...
   * [optParams] - Additional query parameters
   */
  async.Future<PreferredDeals> list({core.Map optParams}) {
    var url = "preferreddeals";
    var urlParams = new core.Map();
    var queryParams = new core.Map();
